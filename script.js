...
document.querySelectorAll('.gallery-card:not([data-image])').forEach(card=>card.addEventListener('click',()=>{lightboxArt.style.backgroundImage='';lightboxArt.classList.remove('has-image');lightboxTitle.textContent=card.dataset.title;dialog.showModal();}));
